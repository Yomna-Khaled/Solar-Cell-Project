...
class ContainersControllerTest < ActionController::TestCase
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post :create, container: { capacity: @container.capacity, height: @container.height, price: @container.price, serialNo: @container.serialNo, total_power: @container.total_power, width: @container.width }
    end
  ...
  test "should update container" do
    patch :update, id: @container, container: { capacity: @container.capacity, height: @container.height, price: @container.price, serialNo: @container.serialNo, total_power: @container.total_power, width: @container.width }
    assert_redirected_to container_path(assigns(:container))
  end
